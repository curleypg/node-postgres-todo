...
Forked from [mjhea0](https://github.com/mjhea0/). Modified to create a customized "inventory" app.
...
1. Start your Postgres server and create a database called "inventory"
1. Create the database tables: `node server/models/database.js`
1. Start the server: `$ npm start`

## Tests

This comes with a load test using [Apache Bench](http://httpd.apache.org/docs/2.2/programs/ab.html) that by default exercises the API endpoint for the `/api/v1/inventory` service:
